...
class ConfigAssemblerAgent(BaseAgent):
    ...
    async def execute(self, task: str, context: dict) -> dict:
        ...
        final_config = await self._assemble_final_config(all_step_outputs, business_desc)
    ...
    async def _assemble_final_config(self, all_step_outputs: Dict, business_desc: str) -> Dict[str, Any]:
        """组装最终配置
